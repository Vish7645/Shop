      ...
      <section className="text-black body-font relative">
        <div className="container px-5 py-24 mx-auto min-h-screen flex">
          ...
          <div className="w-2/3 pr-10">
            ...
            <div className="mb-8">
              <label className="mr-4">Choose Payment Method:</label>
              <select
                value={paymentMethod}
                    ...
                    createOrder={(data, actions) => {
                      return actions.order.create({
                        purchase_units: [
                          {
                            amount: {
                              value: subtotal.toString(), // Total amount in USD
                            },
                          },
                        ],
                      });
          ...
          <div className="w-1/3">
            ...
            <div className="grid grid-cols-1 gap-4">
              {cart.map((item, index) => (
                <div
                  key={index}
                  className="h-32 w-full overflow-hidden rounded-md border border-gray-200"
                >
                  <img
                              ...
                              <li key={index} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    ...
                                    <button
                                      onClick={() => {
                                        removeFromCart(item); // Pass the item directly
