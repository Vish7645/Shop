...
const Footer = () => {
  ...
  <img src="/logo.svg" alt="Logo" class="w-10 h-10 p-2 bg-indigo-500 rounded-full" />
  <span class="ml-3 text-xl">MyShop</span>
</a>


      <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 MyShop —
        <a href="https://x.com/Nobudy76" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@Nobudy76</a>
      </p>
